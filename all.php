<!doctype html>
These are all the entries in the zoo, grouped by their bibtex entry key.
The list can be used to verify that that entries have been correctly labeled as positive results (blue) or negative results (red). One can also verify that the problem names print out correctly.
<p>
<?php
echo `./search.py --all 2>&1`;
